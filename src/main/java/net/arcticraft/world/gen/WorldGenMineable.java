...
public class WorldGenMineable extends WorldGenerator{
	...
	public WorldGenMineable(Block blockToUse, int noOfBlocks, int meta){
		this.mineableBlock = blockToUse;
					...
					for(int var41 = var33; var41 <= var36; ++var41)
					{
						...
						if(var39 * var39 + var42 * var42 < 1.0D)
						{
							for(int var44 = var34; var44 <= var37; ++var44)
							{
								...
								if(var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && world.getBlock(var38, var41, var44) == ACBlocks.frostStone)
								{
									world.setBlock(var38, var41, var44, mineableBlock);
								}
							}
						}
					}
