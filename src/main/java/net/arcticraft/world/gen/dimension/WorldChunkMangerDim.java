...
public class WorldChunkMangerDim extends WorldChunkManager
{
	...
	protected WorldChunkMangerDim()
	{
		this.myBiomeCache = new BiomeCache(this);
		this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
		this.myBiomesToSpawnIn.add(ACBiomeGenBase.frostForest);
	}

	public WorldChunkMangerDim(long seed, WorldType worldtype)
	{
		this();
		GenLayer[] agenlayer = GenLayerDim.makeTheWorld(seed);
		this.myGenBiomes = agenlayer[0];
		this.myBiomeIndexLayer = agenlayer[1];
	}

	public WorldChunkMangerDim(World world)
	{
	...
	public BiomeGenBase getBiomeGenAt(int x, int z)
	{
		...
		if (biome == null)
		{
			return ACBiomeGenBase.frostForest;
		}
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5) {
		...
		for (int i = 0; i < par4 * par5; ++i) {
			if (aint[i] >= 0) {
				...
				par1ArrayOfBiomeGenBase[i] = ACBiomeGenBase.frostForest;
			}
		}
