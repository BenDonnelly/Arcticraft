...
public class ChunkProviderDim implements ITempComponent, IChunkProvider{
	...
	public Chunk provideChunk(int p_73154_1_, int p_73154_2_)
	{
		...
		if(this.mapFeaturesEnabled)
		{
			...
			// p_73154_1_, p_73154_2_, ablock);
			// this.strongholdGenerator.func_151539_a(this, this.worldObj,
			// p_73154_1_, p_73154_2_, ablock);
	...
	public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
	{
		...
		if(biomegenbase instanceof BiomeFrostOcean)
		{
			for(int g = 0; g < 2; g++)
			{
		...
		if(biomegenbase == ACBiomeGenBase.glacier)
		{
			for(int i = 0; i < 10; i++)
			{
				...
				if(r == 10)
				{
					...
					while(y > 0 && this.worldObj.getBlock(x, y + 1, z) != ACBlocks.frostWaterIce && this.worldObj.getBlock(x, y + 1, z) != ACBlocks.frostStone && this.worldObj.getBlock(x, y + 1, z) != ACBlocks.frostDirt)
					{
						y -= 1;
		...
		for(int i = 0; i < 10; i++)
		{
			...
			if(r == 5)
			{
				...
				while(y > 0)
				{
					if((this.worldObj.getBlock(x, y + 3, z) == ACBlocks.arcaneStone || this.worldObj.getBlock(x, y + 3, z) == ACBlocks.frostWaterIce) && this.worldObj.getBlock(x, y + 2, z) != ACBlocks.icicle && this.worldObj.getBlock(x, y + 1, z) != ACBlocks.icicle && this.worldObj.getBlock(x, y, z) != ACBlocks.icicle)
					{
						/*
						 * if(this.worldObj.getBlock(x, y - 1, z) == Blocks.air && this.worldObj.getBlock(x, y, z) == Blocks.air) { this.worldObj.setBlock(x, y, z, ACBlocks.icicle);
						 * 
						 * TileEntityIcicle t = (TileEntityIcicle) this.worldObj.getTileEntity(x, y, z); t.type = 3; t.upsideDown = true;
						 * 
						 * break; } else if(this.worldObj.getBlock(x, y - 1, z) == Blocks.air) { this.worldObj.setBlock(x, y, z, ACBlocks.icicle);
						 * 
						 * TileEntityIcicle t = (TileEntityIcicle) this.worldObj.getTileEntity(x, y, z); t.type = 4; t.upsideDown = true;
						 * 
						 * break; } else if(this.worldObj.getBlock(x, y - 1, z) == Blocks.air) { this.worldObj.setBlock(x, y, z, ACBlocks.icicle);
						 * 
						 * TileEntityIcicle t = (TileEntityIcicle) this.worldObj.getTileEntity(x, y, z); t.type = 5; t.upsideDown = true;
						 * 
						 * break; } } else if(this.worldObj.getBlock(x, y - 1, z) == ACBlocks.arcaneStone || this.worldObj.getBlock(x, y - 1, z) == ACBlocks.frostWaterIce || this.worldObj.getBlock(x, y - 1, z) == ACBlocks.frostGrass ||
						 * this.worldObj.getBlock(x, y - 1, z) == ACBlocks.frostDirt || (this.worldObj.getBlock(x, y, z) == ACBlocks.frostSnow && (this.worldObj.getBlock(x, y - 1, z) == ACBlocks.arcaneStone || this.worldObj.getBlock(x, y - 1, z) ==
						 * ACBlocks.frostWaterIce || this.worldObj.getBlock(x, y - 1, z) == ACBlocks.frostGrass || this.worldObj.getBlock(x, y - 1, z) == ACBlocks.frostDirt))) { if(this.worldObj.getBlock(x, y, z) == Blocks.air &&
						 * this.worldObj.getBlock(x, y + 1, z) == Blocks.air && this.worldObj.getBlock(x, y + 2, z) == Blocks.air) { if(this.worldObj.getBlock(x + 1, y, z) == Blocks.air && this.worldObj.getBlock(x, y, z) == Blocks.air &&
						 * this.worldObj.getBlock(x - 1, y, z) == Blocks.air) { if(this.worldObj.getBlock(x, y, z + 1) == Blocks.air && this.worldObj.getBlock(x, y, z) == Blocks.air && this.worldObj.getBlock(x, y, z - 1) == Blocks.air) {
						 * this.worldObj.setBlock(x, y, z, ACBlocks.icicle);
						 * 
						 * TileEntityIcicle t = (TileEntityIcicle) this.worldObj.getTileEntity(x, y, z); t.type = 0;
						 * 
						 * break; } } } else if(this.worldObj.getBlock(x, y, z) == Blocks.air && this.worldObj.getBlock(x, y + 1, z) == Blocks.air) { if(this.worldObj.getBlock(x + 1, y, z) == Blocks.air && this.worldObj.getBlock(x, y, z) ==
						 * Blocks.air && this.worldObj.getBlock(x - 1, y, z) == Blocks.air) { if(this.worldObj.getBlock(x, y, z + 1) == Blocks.air && this.worldObj.getBlock(x, y, z) == Blocks.air && this.worldObj.getBlock(x, y, z - 1) == Blocks.air)
						 * { this.worldObj.setBlock(x, y, z, ACBlocks.icicle);
						 * 
						 * TileEntityIcicle t = (TileEntityIcicle) this.worldObj.getTileEntity(x, y, z); t.type = 1;
						 * 
						 * break; } } } else if(this.worldObj.getBlock(x, y, z) == Blocks.air) { if(this.worldObj.getBlock(x + 1, y, z) == Blocks.air && this.worldObj.getBlock(x, y, z) == Blocks.air && this.worldObj.getBlock(x - 1, y, z) ==
						 * Blocks.air) { if(this.worldObj.getBlock(x, y, z + 1) == Blocks.air && this.worldObj.getBlock(x, y, z) == Blocks.air && this.worldObj.getBlock(x, y, z - 1) == Blocks.air) { this.worldObj.setBlock(x, y, z, ACBlocks.icicle);
						 * 
						 * TileEntityIcicle t = (TileEntityIcicle) this.worldObj.getTileEntity(x, y, z); t.type = 2;
						 * 
						 * break; } } }
						 */
					}
		...
		for(int i = 0; i < 1; i++)
		{
			...
			while(y > 0 && this.worldObj.getBlock(x, y, z) != ACBlocks.frostGrass && this.worldObj.getBlock(x, y, z) != ACBlocks.frostWaterIce)
				y -= 1;
		...
		for(int i = 0; i < 2; i++)
		{
			...
			while(y > 0 && this.worldObj.getBlock(x, y - 1, z) != ACBlocks.frostWaterBlock)
				y -= 1;

			if(this.worldObj.getBlock(x, y - 1, z) == ACBlocks.frostWaterBlock && this.worldObj.getBlock(x, y + 1, z) == Blocks.air)
			{
		...
		/*
		 * for(int i = 0; i < 2; i++) { int x = p_73153_2_ + rand.nextInt(16); int y = 256; int z = p_73153_3_ + rand.nextInt(16);
		 * 
		 * while(y > 0 && this.worldObj.getBlock(x, y, z) != ACBlocks.frostWaterBlock) y--;
		 * 
		 * if(this.worldObj.getBlock(x, y, z) == ACBlocks.frostWaterBlock) { int max = 500; int min = 0; int r = rand.nextInt(max - min) + min;
		 * 
		 * if(r == 50) { (new WorldGenShip()).generate(worldObj, rand, x, y, z); } }
		 * 
		 * }
		 */
		...
		for(k1 = 0; doGen && k1 < 16; ++k1)
		{
			for(l1 = 0; l1 < 16; ++l1)
			{
				...
				/*
				 * if(this.worldObj.func_147478_e(k1 + k, i2, l1 + l, true)) { int diff = 0;
				 * 
				 * for(int i = -1; i <= 1; i++) { for(int j = -1; j <= 1; j++) { diff += this.worldObj.getPrecipitationHeight(k1 + k + i, l1 + l + j) - i2; } }
				 * 
				 * this.worldObj.setBlock(k1 + k, i2, l1 + l, ACBlocks.frostSnow, MathHelper.clamp_int(diff, -3, 3) + 3, 2); }
				 */
				if(this.worldObj.func_147478_e(k1 + k, i2, l1 + l, true))
				{
					...
					// else
					// {
					this.worldObj.setBlock(k1 + k, i2, l1 + l, this.pickSnow(rand));
					// }
				}
			}
		}
	...
	private Block pickSnow(Random par1Random)
	{
		int var2 = par1Random.nextInt(4);
		return var2 == 0 ? Blocks.snow_layer : Blocks.snow_layer; // ACBlocks.thickSnow;
	}
	...
	{
		return null; // "Stronghold".equals(p_147416_2_) &&
