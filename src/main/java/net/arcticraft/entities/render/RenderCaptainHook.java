...
public class RenderCaptainHook extends Render{
	...
	public static final ResourceLocation texture = new ResourceLocation(Arcticraft.MOD_ID, "textures/entities/item/hook.png");
	public ModelCaptainsHook hook;

	public RenderCaptainHook(){
	...
	{
		this.renderHook((EntityCaptainHook) entity, x, y, z, yaw, partialTicks);
	}
	...
	public void renderRope(EntityCaptain captain, EntityCaptainHook entity, double par2, double par4, double par6, float par8, float par9)
	{
