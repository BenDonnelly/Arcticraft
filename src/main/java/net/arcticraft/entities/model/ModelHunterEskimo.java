...
public class ModelHunterEskimo extends ModelBase {
	// fields
	ModelRenderer body1;
	ModelRenderer body2;
	ModelRenderer body3;
	...
	public ModelHunterEskimo() {
		...
		Shape1.mirror = true;
		setRotation(Shape1, -1.308997F, 0F, 0.0872665F); // this are radians not
															// degrees ;)
	}
	...
	public void setRotationAngles(float f, float f1, float f2, float f3,
		...
		this.rightarm1.rotateAngleX = this.rightarm2.rotateAngleX = MathHelper
				.cos(f * 0.6662F) * 1.4F * f1;
