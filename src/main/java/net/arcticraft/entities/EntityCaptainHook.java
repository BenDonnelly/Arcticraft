...
public class EntityCaptainHook extends EntityThrowable{

	private EntityCaptain captain;

	public EntityCaptainHook(World par1World){
		super(par1World);
	}

	public EntityCaptainHook(World par1World, EntityCaptain captain){
