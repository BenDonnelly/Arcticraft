...
public class GuiACMainMenu extends MenuMain implements GuiYesNoCallback{
	...
	private static final ResourceLocation[] titlePanoramaPaths = new ResourceLocation[] {new ResourceLocation(Arcticraft.MOD_ID + ":textures/title/panorama0.png"), new ResourceLocation(Arcticraft.MOD_ID + ":textures/title/panorama1.png"), new ResourceLocation(Arcticraft.MOD_ID + ":textures/title/panorama2.png"),
			new ResourceLocation(Arcticraft.MOD_ID + ":textures/title/panorama3.png"), new ResourceLocation(Arcticraft.MOD_ID + ":textures/title/panorama4.png"), new ResourceLocation(Arcticraft.MOD_ID + ":textures/title/panorama5.png")};
	private static final ResourceLocation logo = new ResourceLocation(Arcticraft.MOD_ID + ":textures/title/LogoMainMenu.png");
	...
	{		
		...
		else
		{
			...
			this.buttonList.add(new GuiMMButtons(3, 30, i + 7, ("Arcticraft Links")));
	...
	private void func_98060_b(StringTranslate par1StringTranslate, int par2, int par3)
	{
		...
		GuiMMButtons realmButton = new GuiMMButtons(3, 30, par2 - 45 + par3 * 2, par1StringTranslate.translateKey("menu.online"));
	...
	{
		this.buttonList.add(new GuiMMButtons(0, 30, par1 - 65, "Singleplayer"));
		this.buttonList.add(new GuiMMButtons(1, 30, par1 - 65 + par2 * 1, "Multiplayer"));
	}
	...
	public void drawScreen(int par1, int par2, float par3)
	{
		...
		f1 = f1 * 100.0F / (float) (this.fontRendererObj.getStringWidth(this.splashText) + 40);
		GL11.glScalef(f1, f1, f1);
		this.drawCenteredString(this.fontRendererObj, this.splashText, 10, 25, 0x3BA2BC);
		GL11.glPopMatrix();
		...
		for(int i = 0; i < brandings.size(); i++)
		{
			...
			{
				this.drawString(this.fontRendererObj, brd, width - 2 - fontRendererObj.getStringWidth(brd), this.height - (10 + i * (this.fontRendererObj.FONT_HEIGHT + 1)), 16777215);
			}
		}
		String s1 = "Copyright Mojang AB. Do not distribute!";
		String s2 = "Arcticraft Pre-Alpha";
		this.drawString(this.fontRendererObj, s1, 2, this.height - 10, 16777215);
		this.drawString(this.fontRendererObj, s2, width - 2 - fontRendererObj.getStringWidth(s2), this.height - (6 * (this.fontRendererObj.FONT_HEIGHT + 1)), 0x3BA2BC);
