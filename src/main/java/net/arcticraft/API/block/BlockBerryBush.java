...
public class BlockBerryBush extends BlockCrops {
	...
	protected boolean canPlaceBlockOn(Block p_149854_1_) {
		return p_149854_1_ == ACBlocks.frozenFarmland;
	}
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		...
		for (int i = 0; i < this.iconArray.length; ++i) {
			this.iconArray[i] = p_149651_1_.registerIcon(this.getTextureName()
					+ "_stage_" + i);
		}
	}
}