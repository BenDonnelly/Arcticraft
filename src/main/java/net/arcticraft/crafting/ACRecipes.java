...
public class ACRecipes{
	...
	public static void pouches()
	{
		...
		GameRegistry.addRecipe(new ItemStack(ACItems.arcticPouch, 1,  1), new Object[] {"S S", "LDL", "LLL", Character.valueOf('S'), Items.string, Character.valueOf('L'), Items.leather, Character.valueOf('D'), new ItemStack(Items.dye, 1, 3)});
		GameRegistry.addRecipe(new ItemStack(ACItems.arcticPouch, 1,  2), new Object[] {"S S", "LDL", "LLL", Character.valueOf('S'), Items.string, Character.valueOf('L'), Items.leather, Character.valueOf('D'), new ItemStack(Items.dye, 1, 6)});
		GameRegistry.addRecipe(new ItemStack(ACItems.arcticPouch, 1,  3), new Object[] {"S S", "LDL", "LLL", Character.valueOf('S'), Items.string, Character.valueOf('L'), Items.leather, Character.valueOf('D'), new ItemStack(Items.dye, 1, 13)});
		GameRegistry.addRecipe(new ItemStack(ACItems.arcticPouch, 1,  4), new Object[] {"S S", "LDL", "LLL", Character.valueOf('S'), Items.string, Character.valueOf('L'), Items.leather, Character.valueOf('D'), new ItemStack(Items.dye, 1, 14)});
		GameRegistry.addRecipe(new ItemStack(ACItems.arcticPouch, 1,  5), new Object[] {"S S", "LDL", "LLL", Character.valueOf('S'), Items.string, Character.valueOf('L'), Items.leather, Character.valueOf('D'), new ItemStack(Items.dye, 1, 9)});
		GameRegistry.addRecipe(new ItemStack(ACItems.arcticPouch, 1,  6), new Object[] {"S S", "LDL", "LLL", Character.valueOf('S'), Items.string, Character.valueOf('L'), Items.leather, Character.valueOf('D'), new ItemStack(Items.dye, 1, 5)});
		GameRegistry.addRecipe(new ItemStack(ACItems.arcticPouch, 1,  7), new Object[] {"S S", "LDL", "LLL", Character.valueOf('S'), Items.string, Character.valueOf('L'), Items.leather, Character.valueOf('D'), new ItemStack(Items.dye, 1, 1)});
		GameRegistry.addRecipe(new ItemStack(ACItems.arcticPouch, 1,  8), new Object[] {"S S", "LDL", "LLL", Character.valueOf('S'), Items.string, Character.valueOf('L'), Items.leather, Character.valueOf('D'), new ItemStack(Items.dye, 1, 7)});
		GameRegistry.addRecipe(new ItemStack(ACItems.arcticPouch, 1,  9), new Object[] {"S S", "LDL", "LLL", Character.valueOf('S'), Items.string, Character.valueOf('L'), Items.leather, Character.valueOf('D'), new ItemStack(Items.dye, 1, 11)});
		GameRegistry.addRecipe(new ItemStack(ACItems.arcticPouch, 1,  10), new Object[] {"S S", "LDL", "LLL", Character.valueOf('S'), Items.string, Character.valueOf('L'), Items.leather, Character.valueOf('D'), new ItemStack(Items.dye, 1, 0)});
		GameRegistry.addRecipe(new ItemStack(ACItems.arcticPouch, 1,  11), new Object[] {"S S", "LDL", "LLL", Character.valueOf('S'), Items.string, Character.valueOf('L'), Items.leather, Character.valueOf('D'), new ItemStack(Items.dye, 1, 8)});
		GameRegistry.addRecipe(new ItemStack(ACItems.arcticPouch, 1,  12), new Object[] {"S S", "LDL", "LLL", Character.valueOf('S'), Items.string, Character.valueOf('L'), Items.leather, Character.valueOf('D'), new ItemStack(Items.dye, 1, 2)});
		GameRegistry.addRecipe(new ItemStack(ACItems.arcticPouch, 1,  13), new Object[] {"S S", "LDL", "LLL", Character.valueOf('S'), Items.string, Character.valueOf('L'), Items.leather, Character.valueOf('D'), new ItemStack(Items.dye, 1, 10)});
		GameRegistry.addRecipe(new ItemStack(ACItems.arcticPouch, 1,  14), new Object[] {"S S", "LDL", "LLL", Character.valueOf('S'), Items.string, Character.valueOf('L'), Items.leather, Character.valueOf('D'), Items.leather});
		GameRegistry.addRecipe(new ItemStack(ACItems.arcticPouch, 1,  15), new Object[] {"S S", "LDL", "LLL", Character.valueOf('S'), Items.string, Character.valueOf('L'), Items.leather, Character.valueOf('D'), new ItemStack(Items.dye, 1, 12)});
